---
name: agent-browser
description: Deep reference for agent-browser CLI automation. Use for headless browser automation, web scraping, data extraction, multi-step automated workflows, and recurring browser tasks. Prefer invoking browser-router first for general browser tasks to pick the right tool. Specifically use this skill for: complex multi-step web scraping, automated form workflows, persistent browser sessions, annotated screenshots for AI vision, batch command execution, network HAR recording, and auth state management with profiles or session-name.
